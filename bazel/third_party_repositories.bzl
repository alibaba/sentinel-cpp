...
def include_third_party_repositories():
    http_archive(
        ...
        urls = ["https://ghproxy.com/https://github.com/libevent/libevent/releases/download/release-2.1.8-stable/libevent-2.1.8-stable.tar.gz"],
    )
    ...
    http_archive(
        ...
        urls = ["https://ghproxy.com/https://github.com/oneapi-src/oneTBB/archive/v2020.3.tar.gz"],
    ...
    http_archive(
        ...
        urls = ["https://ghproxy.com/https://github.com/fmtlib/fmt/releases/download/5.3.0/fmt-5.3.0.zip"],
    ...
    http_archive(
        ...
        urls = ["https://ghproxy.com/https://github.com/gabime/spdlog/archive/v1.3.1.tar.gz"],
    )
